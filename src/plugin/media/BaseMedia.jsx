 ...
 * @LastEditors: Aco
 * @LastEditTime: 2018-11-19 17:05:17
...
export default class BaseMedia extends Base {
  constructor() {
    super();
    this.entityType = '';
  ...
  blockRendererFn(block) {
    ...
    if (this.entityType === entity.getType()) {
      return {
        component: props => <this.component data={entity.getData()} {...props} />,
  ...
  toggle(data) {
    this.fire(editorState => {
      const { entityKey, editorState: nextEditorState } = createNewEntity(editorState, {
